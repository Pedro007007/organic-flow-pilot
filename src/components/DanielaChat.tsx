    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 py-8 bg-gray-50">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-3">
        ...
        <Button
          type="submit"
          disabled={saving}
          className="w-full rounded-xl bg-gradient-to-r from-red-600 to-orange-500 hover:from-blue-700 hover:to-teal-600 text-white font-bold text-sm py-2.5"
        >
    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-gradient-to-r from-red-600 to-orange-500 pl-2 pr-5 py-2 text-white shadow-2xl shadow-red-500/30 hover:shadow-red-500/50 transition-all duration-300 hover:scale-105 group"
        >
          <div className="relative">
      ...
      {open && (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col w-[380px] max-w-[calc(100vw-2rem)] h-[560px] max-h-[calc(100vh-4rem)] rounded-2xl bg-white shadow-2xl border border-gray-200 overflow-hidden animate-scale-in">
          {/* Header */}
          <div className="flex items-center gap-3 bg-gradient-to-r from-red-600 to-orange-500 px-4 py-3">
            <div className="relative">
              ...
              <div className="border-t border-gray-200 bg-white px-3 py-3">
                ...
                >
                  ...
                  <Button
                    ...
                    className="h-10 w-10 rounded-full bg-gradient-to-r from-red-600 to-orange-500 hover:from-blue-700 hover:to-teal-600 text-white shadow-md flex-shrink-0"
                  >
