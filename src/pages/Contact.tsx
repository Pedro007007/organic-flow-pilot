          ...
          <div className="mx-auto max-w-4xl px-6">
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-8 text-center hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-red-500 shadow-lg mx-auto mb-6">
                ...
                <a href="tel:+442029225411117" className="text-red-600 font-bold hover:text-red-700 transition-colors text-lg">
                  +44 029 2254 1117
                </a>
              </div>
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-8 text-center hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300">
                ...
                <a href="mailto:info@searcheraa.com" className="text-red-600 font-bold hover:text-red-700 transition-colors text-lg">
                  info@searcheraa.com
                </a>
              </div>
            ...
            {/* CTA */}
            <div className="mt-16 rounded-2xl bg-gradient-to-r from-red-600 to-red-500 p-10 text-center">
