            ...
            {!showOnboarding && !hasRealContent && (
              <div className="relative overflow-hidden rounded-xl border border-primary/20 bg-primary/5 backdrop-blur-xl p-6 shadow-sm transition-all duration-300 hover:shadow-md">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  <button onClick={() => setActiveSection("content")} className="flex items-center gap-2 rounded-xl border border-border/50 bg-card/70 backdrop-blur-xl px-4 py-3 text-left hover:bg-muted/30 hover:-translate-y-0.5 transition-all duration-300 shadow-sm hover:shadow-md">
                  ...
                  <button onClick={() => setActiveSection("keywords")} className="flex items-center gap-2 rounded-xl border border-border/50 bg-card/70 backdrop-blur-xl px-4 py-3 text-left hover:bg-muted/30 hover:-translate-y-0.5 transition-all duration-300 shadow-sm hover:shadow-md">
                  ...
                  <button onClick={() => setActiveSection("agents")} className="flex items-center gap-2 rounded-xl border border-border/50 bg-card/70 backdrop-blur-xl px-4 py-3 text-left hover:bg-muted/30 hover:-translate-y-0.5 transition-all duration-300 shadow-sm hover:shadow-md">
