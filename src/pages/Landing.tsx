...
const features = [
  ...
  { icon: FileText, title: "Content Pipeline", desc: "Generate, optimize, and publish SEO & AEO-ready content at scale with intelligent automation and editorial control.", color: "bg-gradient-to-br from-orange-500 to-red-600", badge: "AVAILABLE" },
  { icon: Bot, title: "Autonomous Agents", desc: "AI agents continuously monitor rankings, discover opportunities, and take action — 24/7 on autopilot.", color: "bg-gradient-to-br from-red-600 to-orange-400", badge: "POPULAR", badgeColor: "text-rose-500 bg-rose-50 border-rose-200" },
  { icon: BarChart3, title: "Performance Analytics", desc: "Track clicks, impressions, and positions with real-time Google Search Console data and actionable insights.", color: "bg-gradient-to-br from-orange-400 to-red-500", badge: "AVAILABLE" },
  { icon: Target, title: "Competitor Analysis", desc: "Scan competitor domains, uncover their keyword strategies, and find gaps you can exploit for faster growth.", color: "bg-gradient-to-br from-red-500 to-orange-600", badge: "AVAILABLE" },
  { icon: Globe, title: "SEO & AEO Intelligence Reports", desc: "Generate comprehensive audit reports with revenue projections, technical scores, AEO readiness, and shareable client-ready PDFs.", color: "bg-gradient-to-br from-orange-500 to-red-500", badge: "AVAILABLE" },
  { icon: LineChart, title: "Rankings & AI Citation Tracker", desc: "Monitor your Google positions and AI citation appearances across ChatGPT, Perplexity, and Google AI Overviews.", color: "bg-gradient-to-br from-red-400 to-orange-500", badge: "NEW", badgeColor: "text-emerald-600 bg-emerald-50 border-emerald-200" },
  { icon: Cpu, title: "SEO & AEO Fulfilment Engine", desc: "Automated quality checks ensure every piece of content meets on-page SEO, technical SEO, schema markup, and AEO standards.", color: "bg-gradient-to-br from-orange-600 to-red-600", badge: "AVAILABLE" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="text-4xl font-black tracking-tight sm:text-5xl lg:text-[3.5rem] xl:text-6xl leading-[1.15]">
                Get Cited by AI
                <br />
                <span className="inline-block bg-[length:200%_auto] animate-gradient bg-gradient-to-r from-red-600 via-orange-500 to-red-600 bg-clip-text text-transparent pb-1 [text-shadow:0_0_40px_rgba(239,68,68,0.5),0_0_80px_rgba(239,68,68,0.3)] animate-[gradient_3s_ease_infinite,pulse_2s_ease-in-out_infinite]">
                  & Rank on Google
                </span>
              </h1>
