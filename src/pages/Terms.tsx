  ...
  <div className="min-h-screen bg-background text-foreground">
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground [&_h2]:text-foreground [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mt-8 [&_h2]:mb-3 [&_strong]:text-foreground">
        ...
        <p>By accessing or using SEO Engine ("the Service"), you agree to be bound by these Terms & Conditions. If you do not agree to these terms, do not use the Service.</p>

        <h2>2. Description of Service</h2>
        <p>SEO Engine is an AI-powered SEO management platform that provides keyword discovery, content generation, search performance analytics, and automated optimization through integration with Google Search Console and other tools.</p>
        ...
        <p>Content you create using the Service remains your property. The Service itself, including its design, features, and underlying technology, is the intellectual property of SEO Engine and is protected by applicable laws.</p>
        ...
        <p>To the maximum extent permitted by law, SEO Engine shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service, including but not limited to loss of revenue, data, or search rankings.</p>
